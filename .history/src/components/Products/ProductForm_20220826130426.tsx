...
import disabledFormButtonControl from '../../utils/disabledFormButtonControl'
...
function ProductForm({ onSubmit, formProps, onUpdate }: ProductFormProps) {
  ...
  // const disabledFormButtonControl = (labelButton: string) => {
  //   if (
  ...
  return (
    <Form title="Product Form" onSubmit={handleFormSubmit}>
      ...
      <Button
        ...
        color={'primary'}
        variant={'solid'}
        disabled={disabledFormButtonControl({labelButton: labelButton, form: form})}
      />
    </Form>
  )
}
