...
const Table = () => {
  ...
  return (
    <table className="Table">
      ...
      <tbody>
        {organizedData.map((row: { [x: string]: string | number | boolean | ReactElement<any, string | JSXElementConstructor<any>> | ReactFragment | ReactPortal | null | undefined }, i: number) => {
          return (
            <tr key={i}>
